...
export default async function Pemasok() {
  ...
  const pemasokData = pemasok.map((p) => ({
    ...
    kontakNama: p.kontakNama, kontakTelepon: p.kontakTelepon,
    alamat: p.alamat, kecamatan: p.kecamatan, provinsi: p.provinsi,
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      <h2 className="disp" style={{ margin: "4px 0 12px", fontSize: 20 }}>Supplier</h2>

      <TabelPemasok data={pemasokData} bolehKelola={bolehKelola} />
      <p style={{ fontSize: 11.5, color: "var(--muted)", marginTop: 12 }}>
        Penawaran harga tiap supplier kini dikelola langsung di{" "}
