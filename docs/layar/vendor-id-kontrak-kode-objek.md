# Layar — /vendor/[id]/kontrak/[kode]/[objek]

| | |
|---|---|
| Rute Next | `/vendor/[id]/kontrak/[kode]/[objek]` |
| Berkas | `src/app/(app)/vendor/[id]/kontrak/[kode]/[objek]/page.tsx` |
| Menu ERP | PROYEK › Manajemen Proyek › Vendor Management › (drill-down) |
| RPC bootstrap | `proyek_vendor_kontrak_objek_bootstrap` |
