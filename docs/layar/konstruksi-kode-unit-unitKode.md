# Layar — /konstruksi/[kode]/unit/[unitKode]

| | |
|---|---|
| Rute Next | `/konstruksi/[kode]/unit/[unitKode]` |
| Berkas | `src/app/(app)/konstruksi/[kode]/unit/[unitKode]/page.tsx` |
| Menu ERP | PROYEK › Manajemen Proyek › Konstruksi › (drill-down) |
| RPC bootstrap | `proyek_konstruksi_unit_unitKode_bootstrap` |
